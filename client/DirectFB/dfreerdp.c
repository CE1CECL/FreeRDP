...
bolean df_get_fds(freerdp* instance, void** rfds, int* rcount, void** wfds, int* wcount)
{
	dfInfo* dfi;
...
bolean df_check_fds(freerdp* instance, fd_set* set)
{
	dfInfo* dfi;
...
bolean df_pre_connect(freerdp* instance)
{
	dfInfo* dfi;
	bolean bitmap_cache;
	dfContext* context;
...
bolean df_post_connect(freerdp* instance)
{
	rdpGdi* gdi;
	dfInfo* dfi;
	dfContext* context;
...
bolean df_verify_certificate(freerdp* instance, char* subject, char* issuer, char* fingerprint)
{
