...
static INLINE void update_read_coord(STREAM* s, sint32* coord, bolean delta)
{
	sint8 lsi8;
	sint16 lsi16;
...
void update_read_cache_bitmap_order(STREAM* s, CACHE_BITMAP_ORDER* cache_bitmap_order, bolean compressed, uint16 flags)
{
...
void update_read_cache_bitmap_v2_order(STREAM* s, CACHE_BITMAP_V2_ORDER* cache_bitmap_v2_order, bolean compressed, uint16 flags)
{
...
void update_read_cache_bitmap_v3_order(STREAM* s, CACHE_BITMAP_V3_ORDER* cache_bitmap_v3_order, bolean compressed, uint16 flags)
{
	uint8 bitsPerPixelId;
