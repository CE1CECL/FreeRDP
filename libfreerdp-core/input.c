...
static bolean input_recv_sync_event(rdpInput* input, STREAM* s)
{
	uint32 toggleFlags;
...
static bolean input_recv_keyboard_event(rdpInput* input, STREAM* s)
{
...
static bolean input_recv_unicode_keyboard_event(rdpInput* input, STREAM* s)
{
...
static bolean input_recv_mouse_event(rdpInput* input, STREAM* s)
{
...
static bolean input_recv_extended_mouse_event(rdpInput* input, STREAM* s)
{
	uint16 pointerFlags, xPos, yPos;
...
static bolean input_recv_event(rdpInput* input, STREAM* s)
{
	uint16 messageType;
...
bolean input_recv(rdpInput* input, STREAM* s)
{
