...
static bolean freerdp_peer_initialize(freerdp_peer* client)
{
...
static bolean freerdp_peer_get_fds(freerdp_peer* client, void** rfds, int* rcount)
{
...
static bolean freerdp_peer_check_fds(freerdp_peer* client)
{
	rdpRdp* rdp;
	int status;
...
static bolean peer_recv_data_pdu(freerdp_peer* client, STREAM* s)
{
	uint8 type;
	uint16 length;
	uint32 share_id;
...
static bolean peer_recv_tpkt_pdu(freerdp_peer* client, STREAM* s)
{
	rdpRdp *rdp;
	uint16 length;
	uint16 pduType;
...
static bolean peer_recv_fastpath_pdu(freerdp_peer* client, STREAM* s)
{
	uint16 length;
	rdpRdp* rdp;
...
static bolean peer_recv_pdu(freerdp_peer* client, STREAM* s)
{
...
static bolean peer_recv_callback(rdpTransport* transport, STREAM* s, void* extra)
{
