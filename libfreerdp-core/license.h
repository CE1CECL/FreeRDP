...
bolean license_recv(rdpLicense* license, STREAM* s);
bolean license_send(rdpLicense* license, STREAM* s, uint8 type);
...
bolean license_send_valid_client_error_packet(rdpLicense* license);
