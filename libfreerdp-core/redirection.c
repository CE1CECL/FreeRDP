...
bolean rdp_recv_server_redirection_pdu(rdpRdp* rdp, STREAM* s)
{
	uint16 flags;
	uint16 length;
...
bolean rdp_recv_redirection_packet(rdpRdp* rdp, STREAM* s)
{
	rdp_recv_server_redirection_pdu(rdp, s);
	return true;
}

bolean rdp_recv_enhanced_security_redirection_packet(rdpRdp* rdp, STREAM* s)
{
