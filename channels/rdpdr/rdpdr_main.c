...
static void rdpdr_send_device_list_announce_request(rdpdrPlugin* rdpdr, bolean user_loggedon)
{
	int i;
	int pos;
	uint8 c;
...
static bolean rdpdr_process_irp(rdpdrPlugin* rdpdr, STREAM* data_in)
{
	IRP* irp;
