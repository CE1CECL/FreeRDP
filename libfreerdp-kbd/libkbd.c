...
uint8 freerdp_kbd_get_scancode_by_keycode(uint8 keycode, bolean* extended)
{
...
uint8 freerdp_kbd_get_keycode_by_scancode(uint8 scancode, bolean extended)
{
	if (extended)
...
uint8 freerdp_kbd_get_scancode_by_virtualkey(int vkcode, bolean* extended)
{
