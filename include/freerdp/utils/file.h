...
FREERDP_API bolean freerdp_check_file_exists(char* file);
...
FREERDP_API bolean freerdp_path_contains_separator(char* path);
FREERDP_API bolean freerdp_detect_development_mode(rdpSettings* settings);
